...
mkbundle -c -o RdlCmd.c -oo RdlCmd.o --deps RdlCmd.exe RdlEngine.dll RdlCri.dll DataProviders.dll itextsharp.dll Mono.Security.dll Npgsql.dll ICSharpCode.SharpZipLib.dll Mono.Data.Sqlite.dll --static
...
cp ../RdlCmd/bin/BundleLinux/RdlCmd ./linux-rdlcmd-bundle/RdlCmd
cp ../RdlCmd/bin/BundleLinux/RdlEngineConfig.Linux.xml ./linux-rdlcmd-bundle/RdlEngineConfig.Linux.xml
