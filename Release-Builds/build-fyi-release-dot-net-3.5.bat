...
"C:\Windows\Microsoft.NET\Framework\v3.5\MSBuild.exe" "%CD%\..\DataProviders\DataProviders.sln" /toolsversion:3.5 /p:Configuration="Release";Platform="x64" /t:clean;rebuild /m:4

REM "C:\Windows\Microsoft.NET\Framework\v3.5\MSBuild.exe" "..\%CD%\..\OracleSP\OracleSp.sln" /toolsversion:3.5 /p:Configuration="Release";Platform="x64" /t:clean;rebuild /m:4

"C:\Windows\Microsoft.NET\Framework\v3.5\MSBuild.exe" "%CD%\..\RdlAsp\RdlAsp.sln" /toolsversion:3.5 /p:Configuration="Release";Platform="x64" /t:clean;rebuild /m:4

"C:\Windows\Microsoft.NET\Framework\v3.5\MSBuild.exe" "%CD%\..\RdlCmd\RdlCmd.sln" /toolsversion:3.5 /p:Configuration="Release";Platform="x64" /t:clean;rebuild /m:4

"C:\Windows\Microsoft.NET\Framework\v3.5\MSBuild.exe" "%CD%\..\RdlCri\RdlCri.sln" /toolsversion:3.5 /p:Configuration="Release";Platform="x64" /t:clean;rebuild /m:4

"C:\Windows\Microsoft.NET\Framework\v3.5\MSBuild.exe" "%CD%\..\RdlDesign\RdlDesign.sln" /toolsversion:3.5 /p:Configuration="Release";Platform="x64" /t:clean;rebuild /m:4

"C:\Windows\Microsoft.NET\Framework\v3.5\MSBuild.exe" "%CD%\..\RdlDesktop\RdlDesktop.sln" /toolsversion:3.5 /p:Configuration="Release";Platform="x64" /t:clean;rebuild /m:4

"C:\Windows\Microsoft.NET\Framework\v3.5\MSBuild.exe" "%CD%\..\RdlEngine\RdlEngine.sln" /toolsversion:3.5 /p:Configuration="Release";Platform="x64" /t:clean;rebuild /m:4

"C:\Windows\Microsoft.NET\Framework\v3.5\MSBuild.exe" "%CD%\..\RdlMapFile\RdlMapFile.sln" /toolsversion:3.5 /p:Configuration="Release";Platform="x64" /t:clean;rebuild /m:4

"C:\Windows\Microsoft.NET\Framework\v3.5\MSBuild.exe" "%CD%\..\RdlViewer\RdlViewer.sln" /toolsversion:3.5 /p:Configuration="Release";Platform="x64" /t:clean;rebuild /m:4
...
copy ..\RdlDesign\bin\x64\Release\RdlDesigner.exe .\my-fyi-build-dot-net-2-x64\RdlDesigner.exe /Y
copy ..\RdlDesktop\bin\x64\Release\RdlDesktop.exe .\my-fyi-build-dot-net-2-x64\RdlDesktop.exe /Y
copy ..\RdlDesktop\bin\x64\Release\config.xml .\my-fyi-build-dot-net-2-x64\config.xml /Y
...
copy ..\RdlMapFile\bin\x64\Release\RdlMapFile.exe .\my-fyi-build-dot-net-2-x64\RdlMapFile.exe /Y
