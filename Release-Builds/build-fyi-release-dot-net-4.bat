...
copy "%CD%\..\RdlCri\bin\x86\Release\RdlCri.dll" .\my-fyi-build-dot-net-4-viewer-x86\RdlCri.dll /Y
copy "%CD%\..\RdlViewer\RdlReader\bin\x86\Release\RdlReader.exe" .\my-fyi-build-dot-net-4-viewer-x86\RdlReader.exe /Y
copy "%CD%\..\DataProviders\bin\x86\Release\DataProviders.dll" .\my-fyi-build-dot-net-4-viewer-x86\DataProviders.dll /Y
copy "%CD%\..\RdlEngine\bin\x86\Release\RdlEngine.dll" .\my-fyi-build-dot-net-4-viewer-x86\RdlEngine.dll /Y
copy "%CD%\..\RdlEngine\bin\x86\Release\ICSharpCode.SharpZipLib.dll" .\my-fyi-build-dot-net-4-viewer-x86\ICSharpCode.SharpZipLib.dll /Y
copy "%CD%\..\RdlViewer\bin\x86\Release\RdlViewer.dll" .\my-fyi-build-dot-net-4-viewer-x86\RdlViewer.dll /Y
